...
//             // Добавление вертикальной линии для времени входа в сделку
//             const entryTimeMillis = entryTime.getTime();
//             const expirationTimeMillis = expirationTime.getTime();
//
// // Создание серии для вертикальных линий
//             const verticalLinesSeries = chart.addLineSeries({
//                 color: 'rgba(0, 255, 0, 0.7)', // Зеленый цвет для линии входа
//                 lineWidth: 2,
...
//             });
//
// // Добавление вертикальных линий для времени входа и времени эспирации
...
// });
//
// // Преобразуйте данные для линейной серии
// const lineData = data.map(item => ({ time: item.time, value: item.close }));
// series.setData(lineData);
//
// // Найти среднее значение между максимальной и минимальной ценой
...
//
// // Добавить горизонтальную линию с ценой в середине
// series.createPriceLine({
//     price: middlePrice,
//     color: 'blue',
//     lineWidth: 2,
//     lineStyle: 1, // Прямая линия
// });
