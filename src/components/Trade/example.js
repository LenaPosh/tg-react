...
const MyGraphSecond = () => {
    ...
    useEffect(() => {
        ...
        // const entryTime = new Date('2018-10-24T12:00:00');
        // const expirationTime = new Date('2018-11-25T15:00:00');
...
//             const verticalLinesSeries = chart.addLineSeries({
...
//             verticalLinesSeries.setData([
//                 { time: entryTimeMillis, value: 0 },
//                 { time: entryTimeMillis, value: 100 },
//                 { time: expirationTimeMillis, value: 0 },
//                 { time: expirationTimeMillis, value: 100 },
//             ]);
            ...
            for (let i = 0; i < datesForMarkers.length; i++) {
                const markerValue = datesForMarkers[i].close;
    ...
    return (
        <div style={{ marginLeft: '20px', marginTop: '40px' }}>
            <button onClick={toggleChartType}>
                Switch to {chartType === 'candlestick' ? 'Line' : 'Candlestick'} Chart
            </button>
...
//             priceLineWidth: 1,
//         }).setData([
//             { time: lockTime, value: 0 },
//             { time: lockTime, value: 100 },
//             { time: expirationTime, value: 0 },
//             { time: expirationTime, value: 100 },
//         ]);
//
//         let series;
//
