...
//     const [sellTime, setSellTime] = useState(new Date(1538816400000).getTime()); // Устанавливаем время продажи при загрузке
//
//
...
//                 {
//                     x: buyTime,
//                     y: candlestickData.find((data) => data.x.getTime() === buyTime).y[3],
//                     marker: {
//                         size: 6,
//                         fillColor: '#4CAF50',
//                         strokeWidth: 0,
...
//                 {
//                     x: sellTime,
//                     y: candlestickData.find((data) => data.x.getTime() === sellTime).y[3],
//                     marker: {
//                         size: 6,
//                         fillColor: '#FF9800',
//                         strokeWidth: 0,
...
//     return (
//         <div id="chart">
//             <ReactApexChart options={options} series={[{ data: chartType === 'candlestick' ? candlestickData : lineData }]} type={chartType} height={350} />
//             <button
//                 onClick={() => {
    ...
    return (
        <div>
            <div id="chart" onWheel={handleWheel}>
                <ReactApexChart ref={chartRef} options={options} series={[{ data: chartType === 'candlestick' ? candlestickData : lineData }]} type={chartType} height={350} />
            </div>
            <button
                onClick={() => {
                    setChartType((prevType) => (prevType === 'candlestick' ? 'line' : 'candlestick'));
